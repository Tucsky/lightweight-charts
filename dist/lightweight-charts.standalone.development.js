...
(function () {
    ...
    ***************************************************************************** */
    ...
    function isWhitespaceData(data) {
        return (data.lowerValue === undefined || data.lowerValue === undefined) && data.open === undefined && data.value === undefined;
    }
    ...
    var CloudAreaPaneViewBase = /** @class */ (function (_super) {
        ...
        CloudAreaPaneViewBase.prototype._internal__createRawItemBase = function (time, higherPrice, lowerPrice) {
            return {
                _internal_time: time,
                _internal_higherPrice: higherPrice,
                _internal_lowerPrice: lowerPrice,
                _internal_x: NaN,
        ...
        CloudAreaPaneViewBase.prototype._internal__fillRawPoints = function () {
            ...
            this._internal__items = this._internal__series._internal_bars()._internal_rows().map(function (row) {
                ...
                return _this._internal__createRawItem(row._internal_index, higherValue, lowerValue, colorer);
            });
        };
    ...
    var SeriesCloudAreaPaneView = /** @class */ (function (_super) {
        ...
        SeriesCloudAreaPaneView.prototype._internal__createRawItem = function (time, higherPrice, lowerPrice) {
            return this._internal__createRawItemBase(time, higherPrice, lowerPrice);
        };
    ...
    function checkCloudAreaItem(type, lineItem) {
        ...
        assert(
        // eslint-disable-next-line @typescript-eslint/tslint/config
        typeof lineItem.higherValue === 'number', type + " series item data higher value must be a number, got=" + typeof lineItem.higherValue + ", value=" + lineItem.higherValue);
        assert(
        // eslint-disable-next-line @typescript-eslint/tslint/config
        typeof lineItem.lowerValue === 'number', type + " series item data lower value must be a number, got=" + typeof lineItem.lowerValue + ", value=" + lineItem.lowerValue);
    }
